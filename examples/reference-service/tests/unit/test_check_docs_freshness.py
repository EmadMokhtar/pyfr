...
def test_parse_frontmatter_reads_both_keys() -> None:
    ...
    assert meta["covers"] == ["src/reference_service/settings.py"]
...
def test_a_covered_path_that_changed_without_the_page_is_reported() -> None:
    page = Page(
        ...
        last_reviewed=None,
        covers=["src/reference_service/settings.py"],
    )
    changed = {"src/reference_service/settings.py"}
...
def test_a_covers_entry_matches_a_directory_prefix() -> None:
    ...
    page = Page(
        ...
        last_reviewed=None,
        covers=["src/reference_service/api/"],
    )
    changed = {"src/reference_service/api/orders.py"}
    assert uncovered_changes([page], changed) == [
        (
            "docs/reference/http-api.md",
            "src/reference_service/api/",
        )
    ]
