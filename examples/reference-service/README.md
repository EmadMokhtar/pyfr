...
architectures and pushes `ghcr.io/emadmokhtar/reference-service`
and `ghcr.io/emadmokhtar/reference-service-migrations`
under the
...
- **After the first release, make each GHCR package public** under the
  ...
  `github.com/EmadMokhtar/reference-service`
